...
import com.moreo.shorlink.project.dao.entity.*;
import com.moreo.shorlink.project.dao.mapper.*;
...
import com.moreo.shorlink.project.dto.resp.*;
...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    private void shortLinkStats(String fullShortUrl, String gid, ServletRequest request, ServletResponse response) {
        ...
        try {
            ...
            String actualProvince = unknownFlag ?  "未知" : province;
            String actualCity = unknownFlag ? "未知" : localeResultObj.getString("city");
            String actualCode = unknownFlag ? "未知" : localeResultObj.getString("adcode");
            ...
            LinkNetworkStatsDO linkNetworkStatsDO = LinkNetworkStatsDO.builder()
                    ...
                    .cnt(1)
                    .build();
            linkNetworkStatsMapper.shorLinkNetworkState(linkNetworkStatsDO);
            ...
            shortLinkMapper.incrementStats(gid, fullShortUrl, 1, uvFirstFlag.get() ? 1 : 0, uvFirstFlag.get() ? 1 : 0);
            LinkStatsTodayDO linkStatsTodayDO = LinkStatsTodayDO.builder()
                    .fullShortUrl(fullShortUrl)
                    .date(date)
                    .todayPv(1)
                    .todayUv(uvFirstFlag.get() ? 1 : 0)
                    .todayUip(uvFirstFlag.get() ? 1 : 0)
                    .build();
